    ...
    packageOverrides = self: super: {
      awscrt = super.awscrt.overridePythonAttrs (oldAttrs: rec {
        ...
        src = oldAttrs.src.override {
          inherit version;
          sha256 = "1kgmnp48hjk61d4b0k367g4ihcnyswvx67wa5w3w19yn1kcdzxhv";
        };
      });
      botocore = super.botocore.overridePythonAttrs (oldAttrs: rec {
        ...
        src = fetchFromGitHub {
          ...
          sha256 = "05p269x3k9dbbkp0hi71pxq84d238kmchl0rpf2vkanzfym6c1l8";
        };
      });
...
with py.pkgs; buildPythonApplication rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "aws-cli";
    rev = version;
    sha256 = "1hrd766ilm9s178la5iiszhakf3njzs6vi9dwzcl5wb26ymm6krd";
  };
