...
- **Python package version bumps** (e.g. `gehomesdk` in `overlay/default.nix`) are guarded by `assertNotStale`. When the assertion fires, nixpkgs has caught up and the override should usually be removed.
