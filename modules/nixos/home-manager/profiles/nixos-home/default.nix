...
in
{
  ...
  options.profiles.nixos-home.enable = mkEnableOption "NixOS home profile";
  ...
  config = mkIf cfg.enable {
    ...
    programs.git.ignores =
      pkgs.mypkgs.gitignore.ghGitIgnoreLines "Global/Linux";
    ...
    xresources.extraConfig = builtins.readFile
      (pkgs.mypkgs.sources.solarized + "/xresources/solarized");
